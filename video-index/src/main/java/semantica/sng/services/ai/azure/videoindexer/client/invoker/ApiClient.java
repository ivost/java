package semantica.sng.services.ai.azure.videoindexer.client.invoker;
...
import semantica.sng.services.ai.azure.videoindexer.client.invoker.auth.Authentication;
import semantica.sng.services.ai.azure.videoindexer.client.invoker.auth.HttpBasicAuth;
import semantica.sng.services.ai.azure.videoindexer.client.invoker.auth.ApiKeyAuth;
import semantica.sng.services.ai.azure.videoindexer.client.invoker.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.java.JavaClientCodegen", date = "2018-04-07T09:02:34.863-07:00")
@Component("semantica.sng.services.ai.azure.videoindexer.client.invoker.ApiClient")
public class ApiClient {
    ...
    private String basePath = "https://videobreakdown.azure-api.net/Breakdowns";
    ...
    protected void init() {
        ...
        //authentications.put("apiKeyQuery", new ApiKeyAuth("query", "Ocp-Apim-Subscription-Key"));
